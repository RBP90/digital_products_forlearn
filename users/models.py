...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    phone_number = models.BigIntegerField(_('phone number'), unique=True, null=True, blank=True,
                                          ...
                                          error_messages={
                                              'unique': _("a user with this phone number already exixts."),
                                          }
                                          )
...
class UserProfile(models.Model):
    ...
    gender = models.BooleanField(_('gender'), null=True, help_text=
                                 _('male is False and female is True. null is unset.'))
...
class Device(models.Model):
    ...
    #                  _('Notify token is not valid'), 'invaid')]
    # )
